...
pbinom(6101, 9821, prob = 0.5, lower.tail = TRUE)
```
b) The 95% confidence interval states that 95% of the time the mean will lie within 0.61 and 0.63 probabiities. It is plausable that the buttered toast will have a 50/50 chance, but it lies outside the confidence interval. 
