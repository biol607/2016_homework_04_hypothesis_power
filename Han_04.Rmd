...
* These have the same probability of a Iype I error.

##### d. Should the tests be one-tailed or two-tailed? Explain.
* The tests should be one-tailed test, because the purpose of COX-2 selective inhibitors are reducing the risk of cardiac arrest.
...
* It is not plausible that there is a 50:50 chance of the toast landing butter-side down, because the 95% confidence interval doesn't inculde 0.5. 
...
* The higher alpha means lesser power; higher SD means higher power.
